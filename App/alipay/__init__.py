...
# 初始化操作
appid = '2016091900550583'
app_notify_url = ''  # 支付完成后，支付宝调用的(通知mykoala服务端)
return_url = ''  # 支付完成后，AXF客户端跳转的页面
app_private_key_path = os.path.join(ALIPAY_ROOT, 'mykaola_private_key.txt')  # 应用私钥
