$(function () {
                ...
                for (let j in data[i]) {
                    ...
                    switch (j) {
                        ...
                        function nextPage() {
                            ...
                            $('.m-bannerBox>ul:first-child>li').eq(currentIndex).animate({
                                'opacity': 0,
                                'z-index': 9
                            }, 400, 'linear', function () {
                            });
                            $('.m-bannerBox>ul:first-child>li').eq(currentIndex + 1).animate({
                                'opacity': 1,
                                'z-index': 10
                            }, 400);
                        ...
                        function hoverPage() {
                            ...
                            $('.m-bannerBox>ul:first-child>li').eq($(this).index()).animate({
                                'opacity': 1,
                                'z-index': 10
                            }, 400);
                        }
    ...
    //
    //     if ($(this).html() == "免费注册") {
    //         location.href = "http://localhost:3000/src/register.html"
    //     } else {
